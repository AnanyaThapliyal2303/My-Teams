...
function DarkMode() {
  ...
  document.getElementById("header-grid").style.backgroundColor=" #0a0a0a";
  document.getElementById("searchBar").style.backgroundColor= "#0a0a0a";
  ...
  document.getElementById("theme").style.backgroundColor=" #0a0a0a";

...
function showForm() {
  ...
  else document.getElementById("event-form-div").style.display = "none";
}
...
function SchedulerMain() {
  ...
  //orders card in ascending order with respect to date
  useEffect(() => {
    ...
    <div className="scheduler-main-div">
      ...
      <div id="scheduler-page">
        ...
        <div id="scheduler-container">
          <button id="btn-eventadd" onClick={showForm}>
            <AddIcon style={{ fontSize: 38, color: "white" }} />
          </button>
          <div>
            <EventScheduler />
          </div>
